(jQuery)(function ($) {
    ...
    if (!is_touch_device()) {
        function set_static_header(position) {
            var header_height = $(".top-bar-wrapper").height();
            if (position > header_height) {
                $(".header-wrapper.header-transparent").addClass("nav-fixed").find('.header-style01 .main-nav').css('margin-top', '0px');
                $(".header-wrapper.header-transparent02").addClass("nav-fixed").find('.header-style01 .main-nav').css('margin-top', '0px');
                $(".video").hide();

            } else {
                $(".header-wrapper.header-transparent").removeClass("nav-fixed").find('.header-style01 .main-nav').css('margin-top', '0px');
                $(".header-wrapper.header-transparent02").removeClass("nav-fixed").find('.header-style01 .main-nav').css('margin-top', '0px');
                $(".video").show();
